-- Include equivalents for placeholder courses in schedule queries
...
BEGIN
  ...
  eligible_equivalents AS (
    ...
    JOIN user_plan up ON true
    JOIN public.course_relation cr ON cr.study_plan_id = up.study_plan_id
