-- 0033_course_active_terms_by_modality.sql
...
COMMENT ON FUNCTION public.get_course_active_academic_terms IS 'Returns active academic terms filtered by the inferred modalities where the course has been offered. Falls back to all active terms when there is no course history.';
