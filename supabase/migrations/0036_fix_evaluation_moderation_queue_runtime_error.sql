-- 0036_fix_evaluation_moderation_queue_runtime_error.sql
...
IS 'Returns evaluation moderation queue for admins. Uses security definer and avoids privileged joins that can fail at runtime.';
