...
const sections: PolicySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Para efectos de esta política, se entiende por usuario a cualquier persona que acceda o utilice el servicio, con o sin cuenta registrada. Se entiende por contenido toda reseña, comentario, archivo, texto, documento o publicación incorporada por quienes participan en este espacio.",
  ...
  },
  {
    ...
    paragraphs: [
      "Este espacio está pensado para fines académicos e informativos. Por esa razón, toda interacción debe mantenerse dentro de un marco de respeto hacia docentes, estudiantes y cualquier otra persona mencionada en publicaciones. Cada usuario responde por el contenido que comparte y por las consecuencias derivadas de afirmaciones falsas, ofensivas o divulgaciones indebidas.",
      ...
      "Podrán restringirse conductas que comprometan la seguridad o el funcionamiento del servicio, incluyendo intentos de manipulación técnica, evasión de controles, uso de cuentas ajenas o acciones orientadas a saturar sistemas y afectar la experiencia de la comunidad.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "Cuando una reseña incumpla estos criterios o exista un riesgo claro para la dignidad, la intimidad o la reputación de alguien, el contenido podrá ocultarse o retirarse de forma inmediata mientras se realiza la revisión correspondiente.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "Si existe un reclamo razonable por privacidad, autoría, confidencialidad o integridad académica, el material podrá ocultarse o retirarse de forma preventiva mientras se analiza el caso. Esta medida busca reducir daño potencial y no requiere certeza absoluta inmediata para ser aplicada.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "Esa licencia se limita al propósito operativo del servicio y no autoriza una apropiación indebida del contenido. Si una publicación infringe derechos de terceros o se comparte sin autorización suficiente, podrá ser removida y la responsabilidad recaerá en quien la haya subido.",
    ],
  },
  {
    ...
    paragraphs: [
      "El tratamiento de datos personales se rige por criterios de minimización, finalidad específica, consentimiento y confidencialidad. Solo se procura recolectar la información necesaria para autenticación, funcionamiento de la cuenta, publicación de contenido, prevención de abuso y atención de incidentes.",
      "Los datos que pueden recopilarse incluyen información básica de cuenta y perfil, registros técnicos de acceso, actividad dentro del servicio y datos asociados a reportes o reclamos. La visibilidad pública se limita a lo estrictamente necesario para la interacción comunitaria y puede depender de la configuración del usuario y de necesidades operativas.",
      "Quien utilice el servicio puede solicitar corrección, actualización o eliminación de sus datos en los casos que correspondan. Aun así, cierta información podrá conservarse por un plazo razonable cuando resulte necesaria para seguridad, cumplimiento de obligaciones, investigación de abusos o resolución de disputas.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Cuando la situación lo requiera, podrán adoptarse medidas rápidas antes de que concluya toda la revisión, con el objetivo de evitar daños mayores. Una vez analizado el caso, la administración podrá mantener, ajustar o revocar la medida aplicada.",
    ],
  },
  {
    ...
    paragraphs: [
      "Las medidas internas se aplican con criterio de proporcionalidad y progresividad, tomando en cuenta la gravedad de la conducta, su impacto, la intención y la reincidencia. El objetivo principal es proteger a la comunidad y corregir conductas, sin renunciar a respuestas firmes cuando el caso lo amerite.",
      "Según cada situación, podrán adoptarse una o varias de las siguientes acciones:",
    ],
    bullets: [
      "Advertencia formal y requerimiento de corrección de conducta.",
      "Ocultamiento o retiro de contenido que incumpla reglas o genere riesgo.",
      "Suspensión temporal de funciones de publicación o de la cuenta.",
      "Cierre de cuenta en casos graves o reiterados.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Para denuncias, reportes, apelaciones, solicitudes de retiro de contenido y ejercicio de derechos sobre datos personales, se pone a disposición el canal interno de reportes y el correo de contacto me@maugp.com.",
      "Para facilitar una atención más ágil, la solicitud debe incluir la identificación del contenido involucrado, el motivo del reclamo y, cuando sea posible, evidencia básica de respaldo. Cada caso se tramitará en un plazo razonable según su complejidad, urgencia y nivel de riesgo para personas o derechos.",
    ],
  },
];
