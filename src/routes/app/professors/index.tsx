...
export const Route = createFileRoute("/app/professors/")({
  component: ProfessorsReviewsPage,
});
...
function ProfessorsReviewsPage() {
  ...
  const minReviewCount = Number.isFinite(Number(minReviewCountInput)) ? Number(minReviewCountInput) : 0;
        ...
        <Card>
          <CardContent className="p-4">
            {rows.length === 0 && query.isLoading ? (
              ...
              <div className="text-sm text-muted-foreground">No hay resultados para los filtros seleccionados.</div>
            ) : (
              <div className="relative min-h-[420px]">
                {query.isFetching ? (
                  <div className="absolute right-2 top-2 z-10 rounded-md border bg-background/95 px-2 py-1 text-xs text-muted-foreground">
                    Actualizando...
                  </div>
                ) : null}
                <Table>
                  ...
                  <PaginationContent>
                    <PaginationItem>
                      <PaginationPrevious
                        ...
                        className={cn(page === 0 || query.isFetching ? "pointer-events-none opacity-50" : "")}
                      />
                    </PaginationItem>
                    <PaginationItem>
                      <PaginationNext
                        ...
                        className={cn(!hasMore || query.isFetching ? "pointer-events-none opacity-50" : "")}
                      />
                    </PaginationItem>
                  </PaginationContent>
                </Pagination>
